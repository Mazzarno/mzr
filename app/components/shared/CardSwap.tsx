...
export interface CardSwapProps {
  ...
  /**
   * Controls where the stack container is placed inside its relative parent.
   * - "right": bottom-right placement (existing default behavior)
   * - "center": perfectly centered within the parent
   */
